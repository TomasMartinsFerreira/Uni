...
/// Notifies all clients subscribed to a key about a change or deletion of the key
/// @param ht The HashTable
/// @param key The key
/// @param fifos An array containing each client's notifications fifo
/// @param fifos_size Size of the fifos array
