...
public class Enrollment {
  ...
  private boolean overlaps(Shift shift1, Shift shift2) {
    // Edge case: All times are exactly the same
    if (shift1.getStartTime().equals(shift1.getEndTime()) && 
        shift1.getStartTime().equals(shift2.getStartTime()) && 
        shift2.getStartTime().equals(shift2.getEndTime())) {
        return true;
    }

    // Standard interval overlap (exclusive of touch points)
