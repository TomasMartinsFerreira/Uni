...
export default new Vuex.Store({
  ...
  mutations: {
    initialiseStore(state) {
      ...
      if (enrollment) {
        state.enrollment = JSON.parse(enrollment);
      }
    },
    ...
    setEnrollment(state: State, enrollment: Enrollment) {
  ...
  actions: {
    ...
    async setEnrollment({ commit }, enrollment: Enrollment) {
  ...
  getters: {
    ...
    getEnrollment(state: State): Enrollment | null {
