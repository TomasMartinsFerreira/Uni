...
import EnrollmentShiftsView from './views/member/EnrollmentShiftsView.vue';
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'activities/:activityId/shifts',
          name: 'institution-activity-shifts',
        ...
        {
          path: 'enrollments/:enrollmentId/shifts',
          name: 'enrollment-shifts',
          component: EnrollmentShiftsView,
          meta: {
            requiredAuth: 'None',
            title: APP_NAME + ' - Manage Enrollment Shifts - Member',
          },
        },
        {
          path: 'assessments',
