...
Cypress.Commands.add('createDatabaseInfoForEnrollments', () => {
  ...
  cy.task('queryDatabase', {
    query: "INSERT INTO " + SHIFT_COLUMNS + generateShiftTuple(1, tomorrow.toISOString(), now.toISOString(), 1, 1),
    credentials: credentials,
  })
   cy.task('queryDatabase', {
    query: "INSERT INTO " + SHIFT_COLUMNS + generateShiftTuple(4, tomorrow.toISOString(), tomorrow.toISOString(), 1, 1),
    credentials: credentials,
  }) 
  cy.task('queryDatabase', {
    query: "INSERT INTO " + SHIFT_COLUMNS + generateShiftTuple(5, tomorrow.toISOString(), tomorrow.toISOString(), 1, 1),
    credentials: credentials,
  })
...
Cypress.Commands.add('createDatabaseInfoForParticipations', () => {
  ...
  cy.task('queryDatabase', {
    query: "INSERT INTO " + USER_COLUMNS + generateUserTuple(6, "VOLUNTEER", "DEMO-VOLUNTEER-4", "VOLUNTEER", "NULL"),
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + AUTH_USERS_COLUMNS + generateAuthUserTuple(6, "DEMO", "demo-volunteer-4", 6),
    credentials: credentials,
  })
  cy.task('queryDatabase', {
  ...
  cy.task('queryDatabase', {
    query: "INSERT INTO " + SHIFT_COLUMNS + generateShiftTuple(3, yesterday.toISOString(), yesterday.toISOString(), 1, 1),
    credentials: credentials,
  })
  cy.task('queryDatabase', {
  ...
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ENROLLMENT_COLUMNS + generateEnrollmentTuple(5, 6),
    credentials: credentials,
  })
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ENROLLMENT_SHIFTS_COLUMNS + " VALUES (5, 1)",
    credentials: credentials,
  })
  cy.task('queryDatabase', {
...
Cypress.Commands.add('createDatabaseInfoForShifts', () => {
  cy.task('queryDatabase', {
    query: "INSERT INTO " + ACTIVITY_COLUMNS + generateActivityTuple(1, "A1", "Long duration", lastYear.toISOString(), lastYear.toISOString(),
      nextYear.toISOString(), 5, 1),
    credentials: credentials,
  })
});
